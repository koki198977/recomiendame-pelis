...
<script setup>
useHead({
  title: 'Solicitar Restablecimiento - Recomiéndame Coach',
  meta: [
    { name: 'description', content: 'Solicita un enlace para restablecer tu contraseña de Recomiéndame Coach. Ingresa tu email y te enviaremos un enlace seguro.' }
  ]
})
