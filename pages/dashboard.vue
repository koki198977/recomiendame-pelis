          ...
          <div class="flex flex-1 flex-col gap-3 px-6 pb-6">
            ...
            <div class="mt-auto grid gap-2">
              <a
                ...
                target="_blank"
                rel="noopener"
                class="inline-flex items-center justify-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm font-semibold text-white/80 transition hover:bg-primary-500/30"
                @click.stop
              >
                🎬 Ver trailer
              </a>
